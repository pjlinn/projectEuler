/*
	...
	that the sum of the factorial of its digits is 
	equal to 145:

	1! + 4! + 5! = 1 + 24 + 120 = 145

	Perhaps less well known is 169, in that it 
	produces the longest chain of numbers that 
	link back to 169; it turns out that there are 
	...
	Did it in python because I didn't feel like writing
	a factorial function.
*/

public class DigitFactorialChains {
	
	// private static Integer factorialChainLink (Integer value, Integer divisor) {
	// 	Integer result = 0;
